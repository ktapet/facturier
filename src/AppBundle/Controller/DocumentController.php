...
class DocumentController extends Controller
{
    ...
    /*
     * o metoda pe care o folosim la aranjarea produselor/serviciilor pe factura si
     * la calculul diferitelor valori ce apar pe orice factura
     * $arr este un vector in care tinem produsele/serviciile, 
     * el poate fi rezultatul unei interogari intr-o baza de date, de exemplu
     * 
     */        
...
/**********************************end date ce vor fi completate pe factura*******************************/            
    ...
    public function generatePdfDoc($produse,$client,$furnizor,$date_factura,$notice,$delegat,$chitanta){
        ...
        // header centru
        $image_file = K_PATH_IMAGES.'logo_pc.png';
        ...
        $pdf->writeHTMLCell (0, 0, 10, 50, 'Cota TVA: 24%');
